"""
🚀 Simple Production Bot - Упрощенный запуск без конфликтов
...
class SimpleMaxxpharmBot:
    """Упрощенный бот без сложных систем"""
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info("✅ Simple Maxxpharm Bot initialized")
            return True
    ...
    async def _setup_handlers(self):
        ...
        async def cmd_order(message: Message):
            ...
            try:
                await message.answer(
                    "📦 <b>Создание заказа</b>\n\n"
                    "Отправьте список лекарств или фото рецепта:\n\n"
                    "📝 <b>Пример:</b>\n"
                    "• Парацетамол - 2 шт\n"
                    "• Витамин C - 1 шт\n\n"
                    "📍 <b>Адрес доставки:</b>\n"
    ...
    async def start(self):
        ...
        try:
            ...
            logger.info("🚀 Starting Simple Maxxpharm Bot...")
    ...
    async def shutdown(self):
        ...
        self.running = False
        logger.info("🛑 Shutting down Simple Maxxpharm Bot...")
        
        try:
            if self.bot:
                await self.bot.session.close()
            
            logger.info("✅ Simple Maxxpharm Bot shutdown completed")
